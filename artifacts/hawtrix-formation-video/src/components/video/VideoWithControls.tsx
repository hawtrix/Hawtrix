  ...
  return (
    ...
    >
      <button
        ...
        title={locked ? 'Boucle scène : activée' : 'Boucle scène : désactivée'}
        aria-label={locked ? 'Boucle scène : activée' : 'Boucle scène : désactivée'}
        aria-pressed={locked}
      >
      ...
      <button
        ...
        title={collapsed ? 'Afficher les contrôles' : 'Masquer les contrôles'}
        aria-label={collapsed ? 'Afficher les contrôles' : 'Masquer les contrôles'}
